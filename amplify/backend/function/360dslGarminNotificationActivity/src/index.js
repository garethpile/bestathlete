...
exports.handler = async (event) => {
  ...
  try {
    ...
    GarminActivityDetails = GarminActivityRequestBody.activities[0];

    console.log("GarminActivityRequestBody: " , GarminActivityRequestBody );

    GarminAccountId = GarminActivityDetails.userId;
    GarminActivityId = GarminActivityDetails.activityId;

    GarminActivityDescription = GarminActivityDetails.activityName;
    GarminActivityType = GarminActivityDetails.activityType;
    GarminActivityStartTime = GarminActivityDetails.startTimeInSeconds;
    GarminActivityDistance = GarminActivityDetails.distanceInMeters;
    GarminActivityDuration = GarminActivityDetails.durationInSeconds;
    GarminAveragePaceInMinutesPerKilometer = GarminActivityDetails.averagePaceInMinutesPerKilometer;
    //GarminActiveKilocalories = GarminActivityDetails.activeKilocalories;
    GarminAverageHeartRateInBeatsPerMinute = GarminActivityDetails.averageHeartRateInBeatsPerMinute;
    ...
    const item = {
      input: {
       ...
       // GarminActiveKilocalories: GarminActiveKilocalories,
        ...
        GarminActivityAthleteBody:"None",
        GarminActivityAthleteEffort:"None",
        GarminActivityAthleteFeedback:0
      },
    };
